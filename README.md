...
- [AI Manor でできること](#ai-manor-でできること)
- [クイックスタート](#クイックスタート)
- [画面例](#画面例)
- [専属エージェント一覧](#専属エージェント一覧)
- [その他の機能](#その他の機能)
...
| 主人の指示 | AI Manor がやること |
|---|---|
| 「来月の引っ越し、やることを整理して」 | タスクに分解し、期限をつけてプロジェクトにまとめる |
...
各担当は自分の表にしか書けません。何を頼めるかは [`docs/staff/`](docs/staff/)。
執事を介さず直接話すなら `manor talk <name>`。
...
| **スマホ連携** Tailscale | `tailscale serve` と passcode。公開 URL は作りません | [`docs/tailscale.md`](docs/tailscale.md) |
| **カレンダー連携** `manor calendar` | ICS を読み、予定に取り込む（読むだけ。書き戻しません） | [ADR-012](docs/design/ADR-012_calendar_and_i18n.md) |
...
| 内容 | 場所 |
|---|---|
| 専属エージェントの詳細 | [`docs/staff/`](docs/staff/) |
| 設計判断 | [`docs/design/`](docs/design/) |
